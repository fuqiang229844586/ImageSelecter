        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    mAudioTrack1VoiceInfos = VideoCropConstant.RECORD_AUDIO_CACHE_PATH_TEMP + File.separator + System
                            .currentTimeMillis() + "_1_AudioData.string";
                    mAudioTrack2VoiceInfos = VideoCropConstant.RECORD_AUDIO_CACHE_PATH_TEMP + File.separator + System
