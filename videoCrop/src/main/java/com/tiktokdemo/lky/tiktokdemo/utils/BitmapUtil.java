...
public class BitmapUtil {
    ...
    public static String saveOverlayBitmapToLocal(){
        ...
        File file = new File(VideoCropConstant.IMAGE_SAVE_PATH + File.separator + fileName);
        if(file.exists()){
        ...
        if(FileUtils.saveBitmapToPNG(bitmap,fileName, VideoCropConstant.IMAGE_SAVE_PATH)){
            return VideoCropConstant.IMAGE_SAVE_PATH + File.separator + fileName;
        }else{
            return "";
        }
    }
