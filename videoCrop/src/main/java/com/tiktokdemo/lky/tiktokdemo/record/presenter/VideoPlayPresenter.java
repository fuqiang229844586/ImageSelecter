...
//                    }
    ...
    public void combineVideo(final float originalVolume, final float backgroundVolume){
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                heyhouVideo.combine(videoInfos, mBGMPath==null?"":mBGMPath,originalVolume,backgroundVolume, VideoCropConstant.RECORD_VIDEO_PATH_TEMP + File.separator + "MIX_Video_" + System
    ...
    public void filterVideo(String videoPath, ArrayList<SpecialEffectsProgressBean> beanArrayList, final HomeCallBack callBack){
        ...
        new HeyhouVideo().filter(videoPath, filterInfos, VideoCropConstant.RECORD_VIDEO_PATH_TEMP + File.separator + "SpecialEffects_" + System
                .currentTimeMillis() + ".mp4", new VideoListener() {
            @Override
            public void onProgress(String outputPath, int percentage) {
    ...
    public void reverseVideo(String videoPath, final HomeCallBack callBack){
        new HeyhouVideo().reverse(videoPath, VideoCropConstant.RECORD_VIDEO_PATH_TEMP + File.separator + "SpecialEffects_" + System
                .currentTimeMillis() + ".mp4", VideoCropConstant.RECORD_VIDEO_PATH_TEMP, new VideoListener() {
            @Override
            public void onProgress(String outputPath, int percentage) {
