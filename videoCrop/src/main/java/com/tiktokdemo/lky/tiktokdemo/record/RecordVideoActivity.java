...
//            });
    ...
    public void onClick(View v) {
        ...
        int i = v.getId();
        if (i == R.id.tidal_pat_record_video_back_img) {
            onBackPressed();

        } else if (i == R.id.tidal_pat_record_video_flash_img) {
            if (CameraEngine.getCameraInfo().isFront) {
                return;
            }
            mPresenter.changeFlashMode();

        } else if (i == R.id.tidal_pat_record_video_flip_img) {
            mPresenter.switchCamera();

        } else if (i == R.id.tidal_pat_record_video_save_img) {
            if (mPresenter.isCombining()) {
                return;
            }
        ...
        } else if (i == R.id.tidal_pat_record_video_beauty_img) {
            mPresenter.changeBeautyOpen();


        } else if (i == R.id.tidal_pat_record_video_filter_img) {
            showFilterRecycler();

        } else if (i == R.id.tidal_pat_record_video_count_down_img) {
        ...
        } else if (i == R.id.tidal_pat_record_video_count_down_img_3) {
            if (mPresenter.isCurrentRecordMax() || !isCanRecord) {
                return;
            }
            hideCountDownLayout(VIDEO_COUNT_DOWN_TIME_3);

        } else if (i == R.id.tidal_pat_record_video_count_down_img_6) {
            if (mPresenter.isCurrentRecordMax() || !isCanRecord) {
                return;
            }
            hideCountDownLayout(VIDEO_COUNT_DOWN_TIME_6);

        } else if (i == R.id.tidal_pat_record_video_count_down_img_9) {
            if (mPresenter.isCurrentRecordMax() || !isCanRecord) {
                return;
            }
        ...
        } else if (i == R.id.tidal_pat_record_delete_view) {
        ...
        } else if (i == R.id.tidal_pat_record_filter_layout) {
            hideFilterRecycler();

        } else if (i == R.id.tidal_pat_record_camera_view) {
        }
    }
