package com.easyphotos.Builder;
...
import com.easyphotos.callback.VideoPreviewCallback;
...
public class AlbumBuilder {
    ...
    private static final String TAG = "com.easyphotos";
     ...
     * @return AlbumBuilder
     */
    public AlbumBuilder setMaxRecordDuration(int duration) {
     ...
     * @return AlbumBuilder
     */
    public AlbumBuilder setMinRecordDuration(int duration) {
        Setting.recordMinDuration = duration;
        return AlbumBuilder.this;
    }
