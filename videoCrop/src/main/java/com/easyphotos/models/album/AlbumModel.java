package com.easyphotos.models.album;
...
import com.easyphotos.models.album.entity.Album;
import com.easyphotos.models.album.entity.AlbumItem;
...
//            Log.d(TAG, "call: " + "Empty photos");
    ...
    public String getAllAlbumName(Context context) {
        ...
        if (Setting.isOnlyVideo()) {
            albumItem_all_name = context.getString(R.string.selector_folder_all_video_photo_easy_photos);
