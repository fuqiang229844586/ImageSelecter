package com.easyphotos.ui.widget.imagezoom;
...
import com.easyphotos.ui.widget.imagezoom.graphics.FastBitmapDrawable;
import com.easyphotos.ui.widget.imagezoom.utils.IDisposable;
import com.tiktokdemo.lky.tiktokdemo.BuildConfig;
...
public abstract class ImageViewTouchBase extends ImageView implements IDisposable {
    ...
    public interface OnScaleChangeListener {
        /**
         * Callback invoked when zoom changed
         *
         * @param scale
         */
        void onScaleChanged(Float scale, float centerX, float centerY);
    }
    ...
    protected void postScale(float scale, float centerX, float centerY) {
        ...
        if (mScaleChangeListener != null) {
            mScaleChangeListener.onScaleChanged(scale, centerX, centerY);
        }
    }
